; ModuleID = 'probe4.86e0e7aa780ec6bf-cgu.0'
source_filename = "probe4.86e0e7aa780ec6bf-cgu.0"
...
define internal void @"_ZN66_$LT$i32$u20$as$u20$core..ops..arith..AddAssign$LT$$RF$i32$GT$$GT$10add_assign17h16a1c26a4f22e54aE"(ptr align 4 %self, ptr align 4 %other, ptr align 8 %0) unnamed_addr #0 {
start:
...
; call core::panicking::panic_const::panic_const_add_overflow
  call void @_ZN4core9panicking11panic_const24panic_const_add_overflow17hc9770482551148b1E(ptr align 8 %0) #4
  unreachable
}

; probe4::probe
; Function Attrs: uwtable
define void @_ZN6probe45probe17h365886a96f637044E() unnamed_addr #1 {
start:
  %x = alloca [4 x i8], align 4
  store i32 1, ptr %x, align 4
; call <i32 as core::ops::arith::AddAssign<&i32>>::add_assign
  call void @"_ZN66_$LT$i32$u20$as$u20$core..ops..arith..AddAssign$LT$$RF$i32$GT$$GT$10add_assign17h16a1c26a4f22e54aE"(ptr align 4 %x, ptr align 4 @alloc_2e38410fced2c310c68bdf2d45d0c3bd, ptr align 8 @alloc_1d9e4a30726589abce1472f3c301cfd2) #5
  ret void
}
...
declare void @_ZN4core9panicking11panic_const24panic_const_add_overflow17hc9770482551148b1E(ptr align 8) unnamed_addr #3
